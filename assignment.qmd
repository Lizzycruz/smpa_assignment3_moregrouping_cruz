...
You haveto  want to make sure that the grouping is done on both columns together, e.g. `group_by(column1, column2)`
...
This is looking at the percentage of constituents who are not white in the district.
